  ...
  return (
    <Card style={{ width: "80%", display: "inline-block", margin: "2%", padding: '15px', backgroundColor: '#B0E0E6', borderRadius: '20px', border: "solid #FFB85A 1px" }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <Card.Body>
          <Card.Title style={{ float: 'none', margin: 0, fontSize: "120%", fontWeight: 'bold' }}>
            {name} {isVerified=="true" && <FaCheckCircle style={{ color: '#1CA1B7', marginLeft: '1%', marginBottom: '2px' }} />} {isVerified=="true" && <p style={{ fontSize: '60%', width: '40%', textAlign: 'left', fontWeight: '500', color: 'black', float: 'right'}}>
  ...
  return (
    <Card style={{ width: '100%', margin: 0, padding: 0, position: 'relative', borderRadius: '10px', borderBottom: 'none' }}>
      ...
      <Card.Body style={{ height: '50em', marginTop: '10px', paddingBottom: '50px', borderRadius: '0 0 10px 10px' }}>
        ...
        >
          <Tab eventKey="first" title={<span className="tab-title">Сипаттама</span>}>
          <Card.Text
